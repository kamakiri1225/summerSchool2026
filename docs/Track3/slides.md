...
<div style="display:flex; flex-wrap:wrap; gap:1.5em; align-items:flex-end; justify-content:center; margin:1.2em 0;">
  <figure style="flex:1 1 240px; max-width:340px; margin:0; text-align:center;">
    <img src="img/002_stirrer/drawing_v2_colored.svg" alt="① X-Z平面に描く壁の断面" style="width:100%; height:auto; max-height:320px; object-fit:contain;">
...
なお、①の赤線は②を押し出したときにできる線と一致するため、①と②のどちらか一方でスケッチしていればよい。
